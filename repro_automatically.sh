{
    ...
    # should fail
    cci task run performance_tests_CO -o vars "field_mapping_method:Data Import Field Mapping,cleanup_first:none,time_to_pause_after_changing_mode:5,count:12000"
